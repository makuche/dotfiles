...
# Print month by typing in first three letters of month
alias jan='cal -m 01'
alias feb='cal -m 02'
alias mar='cal -m 03'
alias apr='cal -m 04'
...
__conda_setup="$('/home/manuel/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/manuel/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/manuel/miniconda3/etc/profile.d/conda.sh"
    else
